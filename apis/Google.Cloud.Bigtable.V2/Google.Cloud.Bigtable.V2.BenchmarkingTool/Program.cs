...
public class Program
{
    ...
    public void Work1(TableName tableName)
    {
        ...
        while (true)
        {
            ...
            BigtableClient client = new BigtableClientBuilder
            {
    ...
    public void Work2(TableName tableName)
    {
        BigtableByteString rowKey = "invalid-rowId";
    ...
    public void Work3(TableName tableName, InstanceName instanceName)
    {
        BigtableByteString rowKey = "invalid-rowId";
    ...
    public static void Main(string[] args)
    {
        ...
        var thread1 = new Thread(() => p.Work1(bigTableInitializer.TableName));
        var thread2 = new Thread(() => p.Work2(bigTableInitializer.TableName));
        var thread3 = new Thread(() => p.Work3(bigTableInitializer.TableName, bigTableInitializer.InstanceName));
